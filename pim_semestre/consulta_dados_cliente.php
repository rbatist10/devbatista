...
<body>
    ...
    <main>
        <section id="cliente">
            <form method="POST" action="./consulta_cadastro.php">
                <div>
                   DIGITE O CPF DO CLIENTE: <input type="text" name="cpf" placeholder="Numero de CPF" required maxlength="14" OnKeyPress="formatar('###.###.###-##', this)"></br>
                    </div>
                <div class="button">

...
/* public -> função será possível acessar por fora do objeto - consegue fazer em qualquer local do sistema
	ex: conexão com banco de dados, verificação de usuário, integridade de usuário.*/
